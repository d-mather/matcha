...
include 'database.php';
  ...
  try {
      ...
      $sql = "CREATE TABLE IF NOT EXISTS profiles (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, username varchar(30) NOT NULL UNIQUE, gender ENUM('male', 'female', 'male+female'), sex_pref ENUM('male', 'female', 'male+female'), age INT, biography varchar(10000), interests varchar(10000), latitude varchar(20), longitude varchar(20), hidden ENUM('no', 'yes'));";
      $conn->exec($sql);
      ...
      $sql = 'CREATE TABLE IF NOT EXISTS public (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, username varchar(30) NOT NULL UNIQUE, likes INT, who_liked varchar(10000), views INT, who_viewed varchar(10000));';
      $conn->exec($sql);
